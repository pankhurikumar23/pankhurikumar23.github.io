...
if __name__ == "__main__":
    ...
    i = [0.4, 0.4, 0.4, 0.4, 0.5, 0.5, 0.5, 0.5, 0.7, 0.79, 0.89, 0.89, 0.7, 0.79, 0.89, 0.89, 0.89, 0.7, 0.79, 0.89, 0.89]
    j = [0.4, 0.7, 0.79, 0.89, 0.4, 0.7, 0.79, 0.89, 0.5, 0.6, 0.7, 0.79, 0.5, 0.6, 0.7, 0.79, 0.89, 0.79, 0.7, 0.79, 0.89]
    for k in range(len(i)):
        y_pred = predict_threshold_groups(lr, x, i[k], j[k], women)
        ...
        print("Male: " + str(i[k]) + " " + str(j[k]))
        print(res1)
        print("Female: " + str(i[k]) + " " + str(j[k]))
        print(res2)
