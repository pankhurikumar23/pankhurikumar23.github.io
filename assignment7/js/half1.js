...
function preload() {
	stateData = loadTable('assets/View1.csv', 'csv', 'header');
}
...
function loadData() {
	stateLabels = stateData.getColumn("State");
	imr = stateData.getColumn("IMR");
	health = stateData.getColumn("Health");
	literacy = stateData.getColumn("Literacy");
}
